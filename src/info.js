...
function render() {
   ...
   <div class="info-container">
       <div class="info-container-header">
           <h3 class="product-title" >${pageProduct.name}</h3>
           <p class="product-info"><i class="fas fa-award product-info-link"></i>Hàng chính hãng - bảo hành 12 Tháng</p> 
       </div>
       <p class="discount"><i class="fas fa-tag product-discount-link"></i> Giảm giá 20%</p>
       <h3 class="price"> Giá: ${currency(pageProduct.price)}</h3>             
       ...
       <div class="info-container-btn">
            ...
            <div class="product-btn-text"> 
               <i class="fas fa-money-bill-wave product-btn-link"></i>Chọn mua
            </div>
            </button>
       </div>
   </div>`
...
$('.info-container-btn button').addEventListener('click', () => { 
   if (loginUser) {
